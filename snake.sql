...
-- ----------------------------
INSERT INTO `snake_user` VALUES ('1', 'admin', '21232f297a57a5a743894a0e4a801fc3', '54', '192.168.79.251', '1515508590', 'admin', '1', '1');
...
CREATE TABLE `snake_winning` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='中奖明细表';
