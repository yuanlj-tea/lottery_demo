...
-- ----------------------------
-- Table structure for snake_award
-- ----------------------------
DROP TABLE IF EXISTS `snake_award`;
CREATE TABLE `snake_award` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `rounds` int(11) NOT NULL COMMENT '抽奖轮数(1,2,3,4......)',
  `prize_num` int(11) NOT NULL COMMENT '几等奖',
  `name` varchar(255) NOT NULL COMMENT '奖项名称',
  `desc` varchar(255) NOT NULL COMMENT '奖项描述',
  `probability` int(11) NOT NULL COMMENT '抽奖概率',
  `addtime` datetime NOT NULL COMMENT '添加奖项时间',
  `pic` varchar(255) DEFAULT NULL COMMENT '图片地址',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='奖项表';

-- ----------------------------
-- Records of snake_award
-- ----------------------------
INSERT INTO `snake_award` VALUES ('1', '1', '1', '一等奖', '呵呵', '1', '2018-01-08 21:51:19', null);
INSERT INTO `snake_award` VALUES ('2', '1', '2', '二等奖', '嘻嘻', '20', '2018-01-08 21:51:42', null);
INSERT INTO `snake_award` VALUES ('3', '1', '3', '三等奖', '哈哈', '30', '2018-01-08 21:52:02', null);
INSERT INTO `snake_award` VALUES ('4', '1', '4', '四等奖', '呼呼', '50', '2018-01-08 21:52:20', null);
INSERT INTO `snake_award` VALUES ('5', '1', '5', '五等奖', '嘻嘻', '100', '2018-01-08 21:52:42', null);
...
CREATE TABLE `snake_log` (
  ...
  `order_num` int(11) NOT NULL COMMENT '购物小票的id',
  `name` varchar(255) NOT NULL COMMENT '中奖人中文名',
  `telphone` varchar(255) NOT NULL COMMENT '中奖人电话',
...
-- ----------------------------
INSERT INTO `snake_user` VALUES ('1', 'admin', '21232f297a57a5a743894a0e4a801fc3', '51', '127.0.0.1', '1515476269', 'admin', '1', '1');

-- ----------------------------
-- Table structure for snake_winning
-- ----------------------------
DROP TABLE IF EXISTS `snake_winning`;
CREATE TABLE `snake_winning` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `award_id` int(11) NOT NULL COMMENT '奖项的id,关联award表的id',
  `datetime` datetime NOT NULL COMMENT '中奖日期',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='中奖明细表';

-- ----------------------------
-- Records of snake_winning
-- ----------------------------
INSERT INTO `snake_winning` VALUES ('1', '5', '2018-01-09 23:17:47');
INSERT INTO `snake_winning` VALUES ('2', '4', '2018-01-09 23:22:40');
INSERT INTO `snake_winning` VALUES ('3', '5', '2018-01-09 23:22:52');
INSERT INTO `snake_winning` VALUES ('4', '5', '2018-01-09 23:23:00');
INSERT INTO `snake_winning` VALUES ('5', '5', '2018-01-10 09:24:48');
